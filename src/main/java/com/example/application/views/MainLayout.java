 ...
 */
@PWA(name = "Theme development", shortName = "Theme development", enableInstallPrompt = false)
@Theme(themeFolder = "breeze")
@PageTitle("Main")
@StyleSheet("context://lumo-css-framework/all-classes.css")
@StyleSheet("context://view-styles.css")
public class MainLayout extends AppLayout {
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Component View", ComponentView.class), //

                new MenuItemInfo("Charts View", ChartsView.class), //
